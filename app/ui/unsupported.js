...
module.exports = function(state, emit) {
  ...
  return html`
    <main class="main">
      ...
      <section
        class="flex flex-col items-center justify-center text-center bg-white m-6 px-6 py-8 border-default border-grey-30 md:border-none md:px-12 md:py-16 shadow-default w-full md:h-full"
      >
